...
Folder: Case_Cubic:                 Correspond to the cases with idealized homogeneous statistics (Sections 3).
...
Folder: Case_TBL:                    Correspond to the turbulent boundary layer cases (Sections 4).
             { main_GSI.m:             Construct the eigenmodes with GSI, GSI-P and SFG for CFD computation of TBL.
...
Folder: Lib_GSI:                        Contains the functions needed by the Cubic and TBL cases.
             { f_GSI_1D.m:              Optimize the phases of eigenmodes with the BFGS algorithm such that the integrated 
                                               variance of velocity divergence is minimized.
               f_J.m:                        Calculate the integrated variance of velocity divergence as cost function of the optimization
                                                problem.
               f_dJ.m:                      Calculate the first derivative of the integrated variance of velocity divergence to the phases.
               f_Spectra_Pope.m:     Model spectrum presented in Turbulent Flows (Stephen B. Pope, 2000).
               f_Diff.m:                    Calculate the differencing matrix for first derivative. }
